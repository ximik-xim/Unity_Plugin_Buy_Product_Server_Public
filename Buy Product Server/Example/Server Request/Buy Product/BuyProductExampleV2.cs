...
public class BuyProductExampleV2 : AbsBuyProduct
{
    [SerializeField] 
    private string _keyInstanceClass = "";
    private static Dictionary<string, BuyProductExampleV2> _instancesClasses = new Dictionary<string, BuyProductExampleV2>();
    private Dictionary<int, BuyProductExampleV2Data> _dataCallbackUploadingData = new Dictionary<int, BuyProductExampleV2Data>();
    ...
    public override void BuyLogic(Action<int, KeyProductId, StatusCallBackServer, BuyProductData, string> callback, int id, KeyProductId keyProduct, string keyInstanceClass)
    {
        ...
        var data = new BuyProductExampleV2Data(callback, keyInstanceClass, id);
    ...
    private static void CallbackDataBuyProduct(string keyInstanceClass, int identifierRequest, string productId, string jsonData, string statusData)
    {
        ...
        BuyProductData dataServer = JsonUtility.FromJson<BuyProductData>(jsonData); 
...
public class BuyProductExampleV2Data
{
    public BuyProductExampleV2Data(Action<int, KeyProductId, StatusCallBackServer, BuyProductData, string> callBack, string keyInstanceClass, int id)
    {
        _callBack = callBack;
        _id = id;
    ...
    private Action<int, KeyProductId, StatusCallBackServer, BuyProductData, string> _callBack;
    private string _keyInstanceClass;
    private int _id;

    public Action<int, KeyProductId, StatusCallBackServer, BuyProductData, string> CallBack => _callBack;
