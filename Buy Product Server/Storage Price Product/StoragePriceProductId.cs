...
#endif
using UnityEngine;
[CreateAssetMenu(menuName = "Buy Product Server/Storage Price Product Id SO")]
public class StoragePriceProductIdSO  : ScriptableObject, IInitScripObj
{
    [SerializeField] 
    private List<AbsKeyData<GetDataSODataProductId, float>> _listData = new List<AbsKeyData<GetDataSODataProductId, float>>();
    private Dictionary<string, float> _dictionaryData = new Dictionary<string, float>();
